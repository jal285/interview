...
![HTTP/2 二进制分帧层](../images/HTTP2/binary_framing_layer01.svg)
...
![HTTP/2 数据流、消息和帧](../images/HTTP2/streams_messages_frames01.svg)
...
![一个共享连接内的 HTTP/2 请求和响应复用](../images/HTTP2/multiplexing01.svg)
...
![HTTP/2 数据流依赖关系和权重](../images/HTTP2/stream_prioritization01.svg)
...
![服务器为推送资源发起新数据流 (promise) ](../images/HTTP2/push01.svg)
...
![HPACK: HTTP/2 的标头压缩](../images/HTTP2/header_compression01.svg)
